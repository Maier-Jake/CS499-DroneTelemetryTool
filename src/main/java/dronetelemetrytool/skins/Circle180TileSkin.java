...
public class Circle180TileSkin extends TileSkin {
    ...
    // ******************** Constructors **************************************
    public Circle180TileSkin(final Tile TILE) {
        super(TILE);
    ...
    @Override protected void resize() {
        ...
        bar.setLength(-angleStep * (tile.getValue() - tile.getMinValue()));
